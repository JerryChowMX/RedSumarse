      ...
      <div style={{
        ...
        <div>
          ...
          <window.SumaButtonRow style={{ marginTop: 28 }}>
            {!d.active && <Button variant="cta" size="lg" trailingIcon={<Icon name="arrow-right" size={18} />} onClick={() => { window.location.href = INICIATIVAS['3-0'].file; }}>Ver iniciativa actual</Button>}
